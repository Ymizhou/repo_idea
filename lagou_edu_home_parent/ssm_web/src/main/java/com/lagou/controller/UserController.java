...
public class UserController {
    ...
    public ResponseResult findAllUserByPage(@RequestBody UserVO userVO) {
        ...
        ResponseResult responseResult = new ResponseResult(true, 200, "用户分页&多条件查询成功", pageInfo);
    ...
    public ResponseResult findUserRelationRoleById(Integer id){
        ...
        ResponseResult responseResult = new ResponseResult(true, 200, "分配角色（回显）成功", list);
